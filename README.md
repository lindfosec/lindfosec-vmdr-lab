...
- [`docs/Lindfosec-Phase1_Summary.pdf`](docs/Lindfosec-Phase1_Summary.pdf) — initial architecture and asset group design
...
- [`docs/Lindfosec-First_Remediation_Cycle_HR_curl.pdf`](docs/Lindfosec-First_Remediation_Cycle_HR_curl.pdf) — full detect-to-verify remediation cycle
